...
def getMinorVersion():
    return Live.Application.get_application().get_minor_version()

def getBugfixVersion():
    return Live.Application.get_application().get_bugfix_version()
...
def getReturnTracks():
    """Returns a list of tracks"""
    return getSong().return_tracks
    
def getTrack(num):
    """Returns track number (num) (starting at 0)"""
    return getSong().tracks[num]

def getReturnTrack(num):
    """Returns track number (num) (starting at 0)"""
    return getSong().return_tracks[num]

def getMasterTrack():
    return getSong().master_track
